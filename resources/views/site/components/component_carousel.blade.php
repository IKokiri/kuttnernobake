<div id="minimal-bootstrap-carousel" class="carousel slide carousel-fade slider-home-one" data-ride="carousel">
    ...
    <div class="carousel-inner" role="listbox">
        <div class="item active slide-1" style="background-image: url(images/RolloverSlide.jpeg);background-position: center center;"></div>
        <div class="item slide-3" style="background-image: url(images/FastloopSlide.jpeg);background-position: center center;"></div>
        <div class="item slide-2" style="background-image: url(images/DesmoldadorSlide.jpeg);background-position: center center;"></div>
    </div>
    <!-- Controls -->
