        ...
        <div class="widgets-section">
            <div class="row clearfix">
                ...
                <div class="footer-column col-md-4 col-sm-6 col-xs-12">
                    <div class="logo"><a href="/"><img src="/images/kuttnernobakesolutionsf.png" alt=""></a></div>
                ...
                <div class="footer-column col-md-4 col-sm-6 col-xs-12">
                    <div class="footer-widget contact-widget">
                        <div class="single-contact-widget">
                            ...
                            <div class="text-box">
                                <h3>Telefone:</h3>
                                <span>+55 19 3302 4770</span>
                                <p>07:00 - 17:00 Segunda - Sexta.</p>
                            </div><!-- /.text-box -->
                        ...
                        <div class="single-contact-widget">
                            ...
                            <div class="text-box">
                                <p>R. Abelardo Benedicto Libório
                                <br>
                                Libéria, 951
                                <br> Piracicaba, São Paulo</p>
                            </div><!-- /.text-box -->
                        </div><!-- /.single-contact-widget -->
                        <div class="single-contact-widget">
                            <div class="icon-box">
