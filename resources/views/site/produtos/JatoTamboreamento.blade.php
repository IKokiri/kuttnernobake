                    ...
                    <div class="services-single">
                        <div class="inner-box">
                            ...
                            <div class="two-column">
                                <div class="row clearfix">  
                                    <div class="image-column col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                        <div class="image-box text-center"><a href="/images/jato tamboreamento g.jpeg" data-fancybox="gallery">
                                        <img src="/images/jato tamboreamento p.jpeg" alt=""></a></div>
                                    </div>
                            ...
                            <div class="two-column">
                                <div class="row clearfix">  
                                    <div class="image-column col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                        <div class="image-box text-center"><a href="/images/jato tamboreamento2 g.jpeg" data-fancybox="gallery">
                                        <img src="/images/jato tamboreamento2 p.jpeg" alt=""></a></div>
                                    </div>
                                    <div class="info-column col-lg-5 col-md-12 col-sm-12 col-xs-12">
                                        <div class="inner-column">
