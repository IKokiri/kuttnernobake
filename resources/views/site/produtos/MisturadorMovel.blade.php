                            ...
                            <div class="two-column">
                                <div class="row clearfix">  
                                    <div class="image-column col-lg-7 col-md-12 col-sm-12 col-xs-12">
                                        <div class="image-box">
                        <a href="/images/produtos/Misturador móvel III.jpg" data-fancybox="gallery">
                        <img src="/images/produtos/Misturador móvel III.jpg" alt=""></a></div>
                                    </div>
                            ...
                            <div class="feature-info-block">
                                ...
                                <div class="image-column col-lg-6 col-md-12 col-sm-12 col-xs-12">
                                        <figure class="image"><img src="/images/produtos/Misturador móvel II.jpg" alt=""></figure>
                                    </div>
                                    <div class="image-column col-lg-6 col-md-12 col-sm-12 col-xs-12">
