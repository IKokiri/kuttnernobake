            ...
            <div class="row clearfix">
                ...
                <div class="content-side pull-right col-lg-9 col-md-8 col-sm-12 col-xs-12">
                    <div class="services-single">
                        <div class="inner-box">
                            <div class="sec-title">
                                <h2>Jato com Gancheira tipo Y</h2>
                                <div class="link-box">
                                    <a href="/contato/kuttnernobake?produto=Orçamento - Jato com Gancheira tipo Y#orcamentoContato">
                                    <h3>
                                    Orçamento
                                    </h3>
                                    </a>
...
O operador não é necessário permanecer ao lado nem no interior da câmara de jateamento.
                            ...
                            <div class="two-column">
                                <div class="row clearfix">  
                                    <div class="image-column col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                        <div class="image-box text-center"><a href="/images/produtos/Gancheira tipo Y g.jpeg" data-fancybox="gallery">
                                        <img src="/images/produtos/Gancheira tipo Y p.jpeg" alt=""></a></div>
                                    </div>
                            ...
                            <div class="text text-justify">
                                <p>Durante a projeção da granalha, as gancheiras são mantidas em rotação constante e automaticamente a rotação do gancho é revertida para otimizar a exposição de todas as superfícies e deste modo assegurar a uniformidade do jateamento. Após o tratamento o transportador leva o conjunto para fora da câmara pelo mesmo lado da entrada de peças, uma vez que existe uma monovia onde o carro que suporta o gancho é apoiado essa monovia esta disposta apenas do lado de entrada de peças, formando propriamente um “Y” de entrada devido aos dois raios da monovia que alimenta o Jato.
</p>
                            </div>
