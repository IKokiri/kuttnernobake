            ...
            <div class="row clearfix">
                ...
                <div class="content-side pull-right col-lg-9 col-md-8 col-sm-12 col-xs-12">
                    <div class="services-single">
                        <div class="inner-box">
                            <div class="sec-title">
                                <h2>Área de vazamento - Resfriamento</h2>
                                <div class="link-box">
                                    <a href="/contato/kuttnernobake?produto=Orçamento - Área de vazamento - Resfriamento#orcamentoContato">
                                    <h3>
                                    Orçamento
                                    </h3>
                                    </a>
                            ...
                            <div class="two-column">
                                <div class="row clearfix">  
                                    <div class="image-column col-lg-7 col-md-12 col-sm-12 col-xs-12">
                                        <div class="image-box">
                            <a href="/images/produtos/Area Vazamento Resfriamento g.jpg" data-fancybox="gallery">
                            <img src="/images/produtos/Area Vazamento Resfriamento p.jpg" alt=""></a></div>
                                    </div>
