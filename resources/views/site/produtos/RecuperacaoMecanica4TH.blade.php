                            ...
                            <div class="two-column">
                                <div class="row clearfix">  
                                    <div class="image-column col-lg-7 col-md-12 col-sm-12 col-xs-12">
                                        <div class="image-box"><a href="/images/produtos/Recuperacao Mecanica4th g.jpg" data-fancybox="gallery">
                                        <img src="/images/produtos/Recuperacao Mecanica4th p.jpg" alt=""></a></div>
                                    </div>
